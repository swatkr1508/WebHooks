...
/// </para>
/// <para>
/// When processing each request, <see cref="Routing.WebHookReceiverNameConstraint"/> checks for an applicable
...
/// <see cref="Filters.WebHookEventNameMapperFilter"/> uses this metadata to decide how to parse the request body
/// and how to interpret <see cref="IWebHookEventFromBodyMetadata.BodyPropertyPath"/>.
/// </para>
/// </remarks>
